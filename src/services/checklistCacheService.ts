 ...
 */
export function updateChecklistCacheOnCreate(
 ...
 */
export function updateChecklistCacheOnUpdate(
   queryClient: QueryClient,
 ...
 */
export function updateChecklistCacheOnDelete(
   queryClient: QueryClient,
   deletedId: number
) {
   queryClient.setQueryData<ChecklistItem[]>(CHECKLIST_QUERY_KEY, (old = []) => {
 ...
 */
export function updateChecklistCacheOnToggle(
   queryClient: QueryClient,
   toggledItem: ChecklistItem
) {
   queryClient.setQueryData<ChecklistItem[]>(CHECKLIST_QUERY_KEY, (old = []) => {
      return old.map(item => 
