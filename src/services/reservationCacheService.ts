 ...
 */
export function updateReservationCacheOnCreate(queryClient: QueryClient, newReservation: Reservation) {
 ...
 */
export function updateReservationCacheOnUpdate(queryClient: QueryClient, updatedReservation: Reservation) {
  queryClient.setQueryData<Reservation[]>(RESERVATION_QUERY_KEY, (old = []) => {
 ...
 */
export function updateReservationCacheOnDelete(queryClient: QueryClient, deletedId: number) {
  queryClient.setQueryData<Reservation[]>(RESERVATION_QUERY_KEY, (old = []) => {
