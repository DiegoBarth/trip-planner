   ...
   return (
      ...
      >
         ...
         <div
            ref={trapRef}
            className={cn(
               'relative w-full max-h-[90vh] bg-white rounded-t-2xl md:rounded-2xl flex flex-col shadow-2xl',
               sizeClasses[size]
            )}
         >
            {/* Header */}
            ...
            {/* Footer */}
            <div className="flex gap-3 p-6 border-t border-gray-200 bg-gray-50/50 flex-shrink-0">
               <button
                  onClick={onClose}
                  disabled={loading}
