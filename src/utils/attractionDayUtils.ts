...
export function getAutoDayForDate(attractions: Attraction[], country: Country, date: string, excludeId?: number): number {
...
export function getNextOrderForDate(attractions: Attraction[], country: Country, date: string, excludeId?: number): number {
  const dateKey = normalizeDateKey(date);
